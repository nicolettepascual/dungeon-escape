...
public class IndigoChest extends StaticEntity{

    public IndigoChest(Handler handler, float x, float y) {
    ...
    public void opened(){
    handler.getWorld().getItemManager().addItem(Item.IndigochestItem.createNew((int) x, (int) y));
    }
