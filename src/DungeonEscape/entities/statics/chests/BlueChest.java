...
public class BlueChest extends StaticEntity{

    public BlueChest(Handler handler, float x, float y) {
    ...
    public void opened(){
    handler.getWorld().getItemManager().addItem(Item.BluechestItem.createNew((int) x, (int) y));
    }
