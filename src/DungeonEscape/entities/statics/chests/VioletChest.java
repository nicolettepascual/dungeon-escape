...
public class VioletChest extends StaticEntity{

    public VioletChest(Handler handler, float x, float y) {
    ...
    public void opened(){
    handler.getWorld().getItemManager().addItem(Item.VioletchestItem.createNew((int) x, (int) y));
    }
