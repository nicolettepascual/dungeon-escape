...
public class OrangeChest extends StaticEntity{

    public OrangeChest(Handler handler, float x, float y) {
    ...
    public void opened(){
    handler.getWorld().getItemManager().addItem(Item.OrangechestItem.createNew((int) x, (int) y));
    }
