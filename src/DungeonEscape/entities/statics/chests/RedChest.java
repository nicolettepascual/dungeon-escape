...
public class RedChest extends StaticEntity{

    public RedChest(Handler handler, float x, float y) {
    ...
    public void opened(){
    handler.getWorld().getItemManager().addItem(Item.RedchestItem.createNew((int) x, (int) y));
    }
