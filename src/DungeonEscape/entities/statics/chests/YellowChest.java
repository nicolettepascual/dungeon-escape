...
public class YellowChest extends StaticEntity{

    public YellowChest(Handler handler, float x, float y) {
    ...
    public void opened(){
    handler.getWorld().getItemManager().addItem(Item.YellowchestItem.createNew((int) x, (int) y));
    }
